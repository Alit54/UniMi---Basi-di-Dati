...
<table class="styled-table" width="100%">
    <tr>
            ...
            <div class="search-box">
                <form action="" method="GET">
                    ...
                    if (!empty($_GET['search'])) {
                        echo '<a href="lista_e_gestione_corsi.php" class="btn btn-primary">Indietro</a>';
                    }
                    ?>
                </form>
            </div>
        ...
        <td align="center">
            <a href="aggiungi_nuovo_corso.php" class="btn btn-success">Aggiungi Nuovo Corso</a>
        </td>
    </tr>
</table>
...
<table class="styled-table" width="100%">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="modifica_corso.php?nome=<?php echo $row['nome']; ?>" class="btn btn-primary">Modifica</a>
                <a href="elimina_corso.php?nome=<?php echo $row['nome']; ?>" class="btn btn-danger">Elimina</a>
            </td>
        </tr>
        <?php } ?>
    </tbody>
