...
if ($_SESSION['ruolo'] == "studente") { include_once("area_riservata_studenti.php"); 
...
$dati_studente = "SELECT * FROM get_carriera_valida($1)";
...
<table class="styled-table" width="100%">
    ...
    <tbody>
        <?php while ($row_carriera_studente = pg_fetch_assoc($result_carriera_studente)){ 
